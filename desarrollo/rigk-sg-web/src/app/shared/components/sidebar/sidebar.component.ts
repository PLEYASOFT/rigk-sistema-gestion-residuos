...
export class SidebarComponent implements OnInit {
  ...
  menuAdmin = [
    ...
    { title: "Mantenedor Empresas", path: "#/mantenedor/business", icon: "fa fa-building" },
    { title: "Mantenedor Establecimientos", path: "#/mantenedor/establishment", icon: "fa-map-location-dot" },
    { title: "Mantenedor Usuarios", path: "#/mantenedor/users", icon: "fa-users" },
    { title: "Mantenedor Gestores", path: "#/mantenedor/managers", icon: "fa-users-gear" },
